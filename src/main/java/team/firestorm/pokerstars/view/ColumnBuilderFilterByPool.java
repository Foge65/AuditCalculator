...
public class ColumnBuilderFilterByPool extends ColumnBuilderFilterByDate {
    private final TabController tabController;
    private final Model model;

    public ColumnBuilderFilterByPool(TabController tabController, Model model) {
    ...
    public void buildColumnSpin() {
        ...
        setCellValueNumber(table, model.getSumProfitPoolSpin(), sumProfit);

        TableColumn<Model, BigDecimal> sumBonus = new TableColumn<>("Sum\nBonus");
        setCellValueNumber(table, model.getSumBonusPoolSpin(), sumBonus);
